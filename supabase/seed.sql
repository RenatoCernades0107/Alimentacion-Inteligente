...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'ceviche', 'PE', 'Ceviche', 'Ceviche', 'Pescado fresco marinado en limón con cebolla roja, ají y culantro.', 'Fresh fish cured in lime juice with red onion, chili and cilantro.', '🐟', array['lunch']::text[], 4, 30, 'https://www.hora.es/platos-peruanos-caseros/#1-ceviche-peruano',
...
on conflict (slug) do update set country = excluded.country, name_es = excluded.name_es, name_en = excluded.name_en,
  description_es = excluded.description_es, description_en = excluded.description_en, emoji = excluded.emoji,
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'causa-limena', 'PE', 'Causa limeña', 'Causa limeña', 'Capas de papa amarilla con ají y limón, rellenas de pollo y palta.', 'Layers of yellow potato seasoned with chili and lime, filled with chicken and avocado.', '🥔', array['lunch', 'dinner']::text[], 4, 45, 'https://www.hora.es/platos-peruanos-caseros/#3-causa-limena',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'papa-a-la-huancaina', 'PE', 'Papa a la huancaína', 'Papa a la huancaína', 'Papas bañadas en una crema de queso fresco y ají amarillo.', 'Potatoes covered in a creamy fresh cheese and yellow chili sauce.', '🥔', array['lunch', 'dinner', 'snack']::text[], 4, 30, 'https://www.hora.es/platos-peruanos-caseros/#4-papa-a-la-huancaina',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'lomo-saltado', 'PE', 'Lomo saltado', 'Lomo saltado', 'Salteado de lomo, cebolla y tomate al wok con papas fritas y arroz.', 'Wok-seared beef, onion and tomato with french fries and rice.', '🥩', array['lunch', 'dinner']::text[], 4, 35, 'https://www.hora.es/platos-peruanos-caseros/#31-lomo-saltado',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'aji-de-gallina', 'PE', 'Ají de gallina', 'Ají de gallina', 'Pollo deshilachado en crema de ají amarillo, pan y leche.', 'Shredded chicken in a creamy yellow chili, bread and milk sauce.', '🍛', array['lunch', 'dinner']::text[], 4, 50, 'https://www.hora.es/platos-peruanos-caseros/#32-aji-de-gallina',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'arroz-con-pollo', 'PE', 'Arroz con pollo', 'Peruvian green rice with chicken', 'Arroz verde de culantro con presas de pollo y verduras.', 'Cilantro green rice with chicken pieces and vegetables.', '🍗', array['lunch']::text[], 4, 60, 'https://www.hora.es/platos-peruanos-caseros/#21-arroz-con-pollo',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'arroz-chaufa', 'PE', 'Arroz chaufa', 'Arroz chaufa (Peruvian fried rice)', 'Arroz frito al estilo chifa con pollo, huevo y cebolla china.', 'Chinese-Peruvian fried rice with chicken, egg and green onion.', '🍳', array['lunch', 'dinner']::text[], 4, 25, 'https://www.hora.es/platos-peruanos-caseros/#24-arroz-chaufa',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'tallarines-verdes', 'PE', 'Tallarines verdes', 'Peruvian pesto pasta', 'Tallarines con salsa de albahaca, espinaca y queso fresco.', 'Pasta with a basil, spinach and fresh cheese sauce.', '🍝', array['lunch', 'dinner']::text[], 4, 30, 'https://www.hora.es/platos-peruanos-caseros/#28-tallarines-verdes',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'tallarines-rojos', 'PE', 'Tallarines rojos con pollo', 'Peruvian red spaghetti with chicken', 'Tallarines en salsa de tomate con ají panca y presas de pollo.', 'Spaghetti in a tomato and aji panca sauce with chicken.', '🍝', array['lunch', 'dinner']::text[], 4, 50, 'https://www.hora.es/platos-peruanos-caseros/#29-tallarines-rojos',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'pollo-a-la-brasa', 'PE', 'Pollo a la brasa (al horno)', 'Peruvian roast chicken', 'Pollo marinado con sillao, comino y ají panca, con papas y ensalada.', 'Chicken marinated in soy sauce, cumin and aji panca, with fries and salad.', '🍗', array['lunch', 'dinner']::text[], 4, 90, 'https://www.hora.es/platos-peruanos-caseros/#33-pollo-a-la-brasa',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'estofado-de-pollo', 'PE', 'Estofado de pollo', 'Peruvian chicken stew', 'Guiso de pollo con papas, zanahoria y arvejas en salsa de tomate.', 'Chicken stew with potatoes, carrots and peas in tomato sauce.', '🍲', array['lunch', 'dinner']::text[], 4, 50, 'https://www.hora.es/platos-peruanos-caseros/#34-estofado-de-pollo',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'seco-de-res', 'PE', 'Seco de res con frejoles', 'Cilantro beef stew with beans', 'Carne de res guisada en culantro, con frejoles y arroz.', 'Beef braised in cilantro sauce, with beans and rice.', '🍲', array['lunch']::text[], 4, 90, 'https://www.hora.es/platos-peruanos-caseros/#39-seco-con-frejoles',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'bistec-a-lo-pobre', 'PE', 'Bistec a lo pobre', 'Bistec a lo pobre', 'Bistec con huevo frito, plátano frito, papas fritas y arroz.', 'Steak with fried egg, fried plantain, fries and rice.', '🍳', array['lunch']::text[], 4, 35, 'https://www.hora.es/platos-peruanos-caseros/#40-bistec-a-lo-pobre',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'tacu-tacu', 'PE', 'Tacu tacu', 'Tacu tacu', 'Tortilla crocante de arroz y frejoles, ideal para usar sobras.', 'Crispy rice and bean cake, great for leftovers.', '🫘', array['lunch', 'dinner']::text[], 4, 30, 'https://www.hora.es/platos-peruanos-caseros/#41-tacu-tacu',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'sopa-criolla', 'PE', 'Sopa criolla', 'Sopa criolla', 'Sopa de carne molida con fideos, leche y huevo.', 'Ground beef soup with noodles, milk and egg.', '🍜', array['dinner']::text[], 4, 30, 'https://www.hora.es/platos-peruanos-caseros/#12-sopa-criolla',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'aguadito-de-pollo', 'PE', 'Aguadito de pollo', 'Peruvian chicken cilantro soup', 'Sopa espesa de arroz y culantro con pollo y verduras.', 'Hearty cilantro rice soup with chicken and vegetables.', '🍲', array['dinner']::text[], 4, 50, 'https://www.hora.es/platos-peruanos-caseros/#11-aguadito-de-pollo',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'caldo-de-gallina', 'PE', 'Caldo de gallina', 'Peruvian hen soup', 'Caldo concentrado con fideos, papa amarilla y huevo.', 'Rich chicken broth with noodles, yellow potato and egg.', '🍜', array['dinner', 'breakfast']::text[], 4, 120, 'https://www.hora.es/platos-peruanos-caseros/#13-caldo-de-gallina',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'menestron', 'PE', 'Menestrón', 'Menestrón (Peruvian minestrone)', 'Sopa de verduras y carne con pesto de albahaca y queso fresco.', 'Vegetable and beef soup with basil pesto and fresh cheese.', '🥣', array['lunch', 'dinner']::text[], 6, 90, 'https://www.hora.es/platos-peruanos-caseros/#15-menestron-peruano',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'pollo-saltado', 'PE', 'Pollo saltado', 'Pollo saltado', 'Salteado de pollo con cebolla, tomate y papas fritas.', 'Stir-fried chicken with onion, tomato and fries.', '🍗', array['lunch', 'dinner']::text[], 4, 30, 'https://www.hora.es/platos-peruanos-caseros/#58-pollo-saltado',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'sudado-de-pescado', 'PE', 'Sudado de pescado', 'Peruvian steamed fish stew', 'Pescado cocido al vapor en un jugo de tomate, cebolla y ají.', 'Fish steamed in a tomato, onion and chili broth.', '🐟', array['lunch']::text[], 4, 35, 'https://www.hora.es/platos-peruanos-caseros/#62-sudado-de-pescado',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'chupe-de-camarones', 'PE', 'Chupe de camarones', 'Peruvian shrimp chowder', 'Sopa cremosa de camarones con papa, choclo, huevo y queso.', 'Creamy shrimp soup with potato, corn, egg and cheese.', '🦐', array['lunch', 'dinner']::text[], 4, 60, 'https://www.hora.es/platos-peruanos-caseros/#16-chupe-de-camarones',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'anticuchos', 'PE', 'Anticuchos', 'Anticuchos (beef heart skewers)', 'Brochetas de corazón marinado en ají panca, a la parrilla.', 'Grilled beef heart skewers marinated in aji panca.', '🍢', array['dinner', 'snack']::text[], 4, 40, 'https://www.hora.es/platos-peruanos-caseros/#51-anticuchos',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'papa-rellena', 'PE', 'Papa rellena', 'Papa rellena (stuffed potato)', 'Croquetas de papa rellenas de carne molida, fritas.', 'Fried potato croquettes stuffed with ground beef.', '🥔', array['lunch', 'snack']::text[], 4, 60, 'https://www.hora.es/platos-peruanos-caseros/#9-papa-rellena',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'locro-de-zapallo', 'PE', 'Locro de zapallo', 'Peruvian squash stew', 'Guiso cremoso de zapallo con papa, choclo y queso fresco.', 'Creamy squash stew with potato, corn and fresh cheese.', '🎃', array['lunch', 'dinner']::text[], 4, 45, 'https://www.hora.es/platos-peruanos-caseros/#45-locro-de-zapallo',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'pan-con-chicharron', 'PE', 'Pan con chicharrón', 'Pan con chicharrón', 'Pan con chicharrón de cerdo, camote frito y sarsa criolla.', 'Bread roll with crispy pork, fried sweet potato and onion relish.', '🥪', array['breakfast']::text[], 4, 90, 'https://www.hora.es/platos-peruanos-caseros/#54-chicharron-de-cerdo',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'pan-con-palta-y-huevo', 'PE', 'Pan con palta y huevo', 'Avocado and egg toast', 'Desayuno rápido de pan con palta y huevo.', 'Quick breakfast of bread with avocado and egg.', '🥑', array['breakfast', 'snack']::text[], 4, 10, null,
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'quinua-con-manzana', 'PE', 'Quinua con manzana', 'Quinoa apple drink', 'Bebida caliente de quinua con manzana y canela.', 'Warm quinoa drink with apple and cinnamon.', '🥣', array['breakfast', 'snack']::text[], 4, 30, null,
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'avena-con-leche', 'PE', 'Avena con leche', 'Oats with milk', 'Avena caliente con leche y canela, clásica del desayuno.', 'Warm oats cooked with milk and cinnamon.', '🥣', array['breakfast']::text[], 4, 15, null,
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'pancakes', 'US', 'Pancakes', 'Pancakes', 'Panqueques esponjosos con miel de maple.', 'Fluffy pancakes with maple syrup.', '🥞', array['breakfast']::text[], 4, 20, 'https://www.bbcgoodfood.com/recipes/2907669/easy-pancakes',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'eggs-and-bacon', 'US', 'Huevos revueltos con tocino', 'Scrambled eggs and bacon', 'Desayuno clásico americano con tostadas.', 'Classic American breakfast with toast.', '🍳', array['breakfast']::text[], 4, 15, null,
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'buttermilk-biscuits', 'US', 'Biscuits caseros', 'Buttermilk biscuits', 'Panecillos esponjosos de mantequilla.', 'Flaky, buttery homemade biscuits.', '🥐', array['breakfast', 'snack']::text[], 6, 30, 'https://www.theanthonykitchen.com/homemade-buttermilk-biscuits/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'oatmeal', 'US', 'Oatmeal con frutas', 'Oatmeal with fruit', 'Avena cocida con plátano, arándanos y miel de maple.', 'Oatmeal topped with banana, blueberries and maple syrup.', '🥣', array['breakfast']::text[], 4, 10, null,
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'meatloaf', 'US', 'Pastel de carne (meatloaf)', 'Meatloaf', 'Pan de carne horneado con glaseado de kétchup.', 'Classic baked meatloaf with a ketchup glaze.', '🍖', array['dinner', 'lunch']::text[], 6, 75, 'https://www.theanthonykitchen.com/traditional-meatloaf-recipe/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'pot-roast', 'US', 'Asado a la olla (pot roast)', 'Pot roast', 'Carne de res cocida lentamente con papas y zanahorias.', 'Slow-braised beef with potatoes and carrots.', '🥩', array['dinner', 'lunch']::text[], 6, 210, 'https://www.theanthonykitchen.com/tak-39-s-pot-roast-roast-beef-recipe/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'texas-chili', 'US', 'Chili de Texas', 'Texas chili', 'Guiso picante de carne sin frijoles.', 'Bold, bean-free beef chili.', '🌶️', array['dinner', 'lunch']::text[], 6, 150, 'https://www.theanthonykitchen.com/texas-chili-recipe/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'mac-and-cheese', 'US', 'Macarrones con queso', 'Mac and cheese', 'Pasta en salsa cremosa de cheddar.', 'Pasta in a creamy cheddar sauce.', '🧀', array['lunch', 'dinner']::text[], 4, 30, 'https://www.theanthonykitchen.com/shells-and-cheese-homemade-macaroni-recipe/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'fried-chicken', 'US', 'Pollo frito sureño', 'Buttermilk fried chicken', 'Pollo marinado en leche y frito crocante.', 'Chicken marinated in buttermilk and fried until crispy.', '🍗', array['lunch', 'dinner']::text[], 4, 60, 'https://www.theanthonykitchen.com/buttermilk-fried-chicken/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'chicken-pot-pie', 'US', 'Pastel de pollo (pot pie)', 'Chicken pot pie', 'Relleno cremoso de pollo y verduras con masa hojaldrada.', 'Creamy chicken and vegetable filling under a flaky crust.', '🥧', array['dinner']::text[], 6, 75, 'https://www.theanthonykitchen.com/homemade-chicken-pot-pie-real-ingredients-perfect-crust-recipe/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'chicken-and-dumplings', 'US', 'Pollo con dumplings', 'Chicken and dumplings', 'Sopa cremosa de pollo con bolitas de masa.', 'Creamy chicken soup with soft dumplings.', '🍲', array['dinner']::text[], 6, 60, 'https://www.theanthonykitchen.com/creamy-chicken-and-dumplings/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'beef-stew', 'US', 'Guiso de res americano', 'Beef stew', 'Estofado de res con papas y zanahorias.', 'Hearty beef stew with potatoes and carrots.', '🍲', array['dinner', 'lunch']::text[], 6, 150, 'https://www.theanthonykitchen.com/dutch-oven-beef-stew/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'spaghetti-meatballs', 'US', 'Espaguetis con albóndigas', 'Spaghetti and meatballs', 'Albóndigas de res en salsa de tomate sobre espaguetis.', 'Beef meatballs in tomato sauce over spaghetti.', '🍝', array['dinner', 'lunch']::text[], 4, 50, 'https://www.theanthonykitchen.com/easy-spaghetti-meatballs-recipe/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'lasagna', 'US', 'Lasaña', 'Lasagna', 'Capas de pasta, salsa de carne y quesos.', 'Layers of pasta, meat sauce and cheese.', '🍝', array['dinner']::text[], 8, 90, 'https://www.theanthonykitchen.com/lazy-homemade-lasagna-recipe/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'cheeseburgers', 'US', 'Hamburguesas con queso', 'Skillet cheeseburgers', 'Hamburguesas caseras a la sartén con cheddar.', 'Homemade skillet burgers with cheddar.', '🍔', array['lunch', 'dinner']::text[], 4, 25, 'https://www.theanthonykitchen.com/skillet-cheese-burgers-with-a-smoky-mustard-sauce-recipe/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'grilled-cheese', 'US', 'Sándwich de queso a la plancha', 'Grilled cheese', 'Pan dorado con mantequilla y queso derretido.', 'Buttery golden bread with melted cheese.', '🥪', array['lunch', 'snack', 'dinner']::text[], 4, 15, 'https://www.theanthonykitchen.com/havarti-and-cheddar-grilled-cheese-sandwich-recipe/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'tomato-soup', 'US', 'Sopa cremosa de tomate', 'Creamy tomato soup', 'Sopa de tomate suave, ideal con grilled cheese.', 'Smooth tomato soup, perfect with grilled cheese.', '🍅', array['dinner', 'lunch']::text[], 4, 35, 'https://www.theanthonykitchen.com/creamy-tomato-soup-recipe/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'pulled-pork', 'US', 'Cerdo deshilachado BBQ', 'BBQ pulled pork sandwiches', 'Cerdo cocido lento con salsa barbacoa, en pan.', 'Slow-cooked pork with BBQ sauce on buns.', '🐖', array['lunch', 'dinner']::text[], 8, 480, 'https://www.theanthonykitchen.com/bbq-pulled-pork-in-the-slow-cooker/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'smothered-pork-chops', 'US', 'Chuletas en salsa de cebolla', 'Smothered pork chops', 'Chuletas de cerdo en salsa cremosa de cebolla.', 'Pork chops in a creamy onion gravy.', '🥩', array['dinner']::text[], 4, 45, 'https://www.theanthonykitchen.com/smothered-pork-chops/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'steak-fajitas', 'US', 'Fajitas de res', 'Steak fajitas', 'Tiras de res con pimientos y cebolla en tortillas.', 'Seared steak strips with peppers and onion in tortillas.', '🌮', array['dinner', 'lunch']::text[], 4, 40, 'https://www.theanthonykitchen.com/steak-fajitas/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'shrimp-and-grits', 'US', 'Camarones con polenta (grits)', 'Shrimp and grits', 'Camarones salteados sobre sémola de maíz cremosa con queso.', 'Sautéed shrimp over creamy cheese grits.', '🦐', array['dinner', 'breakfast']::text[], 4, 35, 'https://www.theanthonykitchen.com/shrimp-and-grits/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'salmon-dill', 'US', 'Salmón con salsa de eneldo', 'Salmon with dill sauce', 'Salmón al horno con salsa fresca de eneldo y limón.', 'Baked salmon with a fresh dill and lemon sauce.', '🐟', array['dinner']::text[], 4, 25, 'https://www.theanthonykitchen.com/salmon-with-dill-sauce/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'oven-baked-chicken', 'US', 'Pollo al horno', 'Oven baked chicken', 'Presas de pollo sazonadas y horneadas, jugosas y fáciles.', 'Juicy, easy seasoned baked chicken.', '🍗', array['dinner', 'lunch']::text[], 4, 45, 'https://www.theanthonykitchen.com/oven-baked-chicken/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'red-beans-and-rice', 'US', 'Frijoles rojos con arroz', 'Red beans and rice', 'Clásico de Luisiana con salchicha ahumada.', 'Louisiana classic with smoked sausage.', '🫘', array['lunch', 'dinner']::text[], 6, 180, 'https://www.theanthonykitchen.com/slow-cooker-red-beans-and-rice/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'chicken-broccoli-rice-casserole', 'US', 'Gratinado de pollo, brócoli y arroz', 'Cheesy chicken, broccoli and rice casserole', 'Arroz horneado con pollo, brócoli y cheddar.', 'Baked rice with chicken, broccoli and cheddar.', '🥦', array['dinner']::text[], 6, 60, 'https://www.theanthonykitchen.com/cheesy-chicken-broccoli-and-rice-casserole-recipe/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'club-sandwich', 'US', 'Club sándwich', 'Club sandwich', 'Sándwich triple de jamón, tocino, lechuga y tomate.', 'Triple-decker sandwich with ham, bacon, lettuce and tomato.', '🥪', array['lunch', 'snack']::text[], 2, 20, 'https://www.theanthonykitchen.com/the-ultimate-club-sandwich-recipe/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'potato-salad', 'US', 'Ensalada de papa', 'Old-fashioned potato salad', 'Papa, huevo y apio en aderezo de mayonesa y mostaza.', 'Potato, egg and celery in a mayo-mustard dressing.', '🥗', array['lunch', 'snack']::text[], 6, 40, 'https://www.theanthonykitchen.com/old-fashioned-potato-salad-recipe/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'cornbread', 'US', 'Pan de maíz (cornbread)', 'Cornbread', 'Pan dulce de harina de maíz horneado.', 'Slightly sweet baked cornbread.', '🌽', array['snack', 'breakfast']::text[], 8, 35, 'https://www.theanthonykitchen.com/co-cornbread-recipe/',
...
insert into recipes (slug, country, name_es, name_en, description_es, description_en, emoji, meal_types, servings, time_minutes, source_url, steps_es, steps_en) values (
  'peanut-butter-cookies', 'US', 'Galletas de mantequilla de maní', 'Peanut butter cookies', 'Galletas de 3 ingredientes.', 'Easy 3-ingredient cookies.', '🍪', array['snack']::text[], 12, 20, 'https://tasty.co/recipe/3-ingredient-peanut-butter-cookies',
